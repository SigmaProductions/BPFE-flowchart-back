...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\FlowController' => 'getFlowControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/k911/swoole-bundle/src/Bridge/Symfony/HttpFoundation/StreamedResponseListener.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->privates['streamed_response_listener'] ?? $this->getStreamedResponseListenerService());
    ...
    /**
     * Gets the private '.service_locator.bj9pP.o' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Bj9pP_OService()
    {
        return $this->privates['.service_locator.bj9pP.o'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.bj9pP.o'] ?? $this->get_ServiceLocator_Bj9pP_OService()), new RewindableGenerator(function () {
     ...
     *
     * @return \K911\Swoole\Bridge\Symfony\HttpFoundation\StreamedResponseListener
     */
    protected function getStreamedResponseListenerService()
    {
        return $this->privates['streamed_response_listener'] = new \K911\Swoole\Bridge\Symfony\HttpFoundation\StreamedResponseListener(new \Symfony\Component\HttpKernel\EventListener\StreamedResponseListener());
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'SwooleBundle' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\SwooleBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'SwooleBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/k911/swoole-bundle/src/Bridge/Symfony/Bundle'),
            ...
            'swoole.http_server.trusted_proxies' => [

            ],
            'swoole.http_server.trusted_hosts' => [

            ],
            'swoole.http_server.api.host' => '0.0.0.0',
            'swoole.http_server.api.port' => 9200,
