...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerProfileCommand' => ['privates', 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerProfileCommand', 'getServerProfileCommandService', true],
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerReloadCommand' => ['privates', 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerReloadCommand', 'getServerReloadCommandService', true],
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerRunCommand' => ['privates', 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerRunCommand', 'getServerRunCommandService', true],
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStartCommand' => ['privates', 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStartCommand', 'getServerStartCommandService', true],
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStatusCommand' => ['privates', 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStatusCommand', 'getServerStatusCommandService', true],
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStopCommand' => ['privates', 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStopCommand', 'getServerStopCommandService', true],
            ...
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerProfileCommand' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerProfileCommand',
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerReloadCommand' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerReloadCommand',
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerRunCommand' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerRunCommand',
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStartCommand' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStartCommand',
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStatusCommand' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStatusCommand',
            'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStopCommand' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStopCommand',
        ...
        ]), ['about' => 'console.command.about', 'assets:install' => 'console.command.assets_install', 'cache:clear' => 'console.command.cache_clear', 'cache:pool:clear' => 'console.command.cache_pool_clear', 'cache:pool:prune' => 'console.command.cache_pool_prune', 'cache:pool:delete' => 'console.command.cache_pool_delete', 'cache:pool:list' => 'console.command.cache_pool_list', 'cache:warmup' => 'console.command.cache_warmup', 'debug:config' => 'console.command.config_debug', 'config:dump-reference' => 'console.command.config_dump_reference', 'debug:container' => 'console.command.container_debug', 'lint:container' => 'console.command.container_lint', 'debug:autowiring' => 'console.command.debug_autowiring', 'debug:event-dispatcher' => 'console.command.event_dispatcher_debug', 'messenger:consume' => 'console.command.messenger_consume_messages', 'messenger:setup-transports' => 'console.command.messenger_setup_transports', 'debug:messenger' => 'console.command.messenger_debug', 'messenger:stop-workers' => 'console.command.messenger_stop_workers', 'debug:router' => 'console.command.router_debug', 'router:match' => 'console.command.router_match', 'lint:yaml' => 'console.command.yaml_lint', 'secrets:set' => 'console.command.secrets_set', 'secrets:remove' => 'console.command.secrets_remove', 'secrets:generate-keys' => 'console.command.secrets_generate_key', 'secrets:list' => 'console.command.secrets_list', 'secrets:decrypt-to-local' => 'console.command.secrets_decrypt_to_local', 'secrets:encrypt-from-local' => 'console.command.secrets_encrypt_from_local', 'debug:firewall' => 'security.command.debug_firewall', 'security:encode-password' => 'security.command.user_password_encoder', 'security:hash-password' => 'security.command.user_password_hash', 'lexik:jwt:check-config' => 'lexik_jwt_authentication.check_config_command', 'lexik:jwt:generate-token' => 'lexik_jwt_authentication.generate_token_command', 'lexik:jwt:generate-keypair' => 'lexik_jwt_authentication.generate_keypair_command', 'doctrine:database:create' => 'doctrine.database_create_command', 'doctrine:database:drop' => 'doctrine.database_drop_command', 'doctrine:query:sql' => 'doctrine.query_sql_command', 'dbal:run-sql' => 'Doctrine\\DBAL\\Tools\\Console\\Command\\RunSqlCommand', 'doctrine:database:import' => 'doctrine.database_import_command', 'doctrine:cache:clear-metadata' => 'doctrine.cache_clear_metadata_command', 'doctrine:cache:clear-query' => 'doctrine.cache_clear_query_cache_command', 'doctrine:cache:clear-result' => 'doctrine.cache_clear_result_command', 'doctrine:cache:clear-collection-region' => 'doctrine.cache_collection_region_command', 'doctrine:mapping:convert' => 'doctrine.mapping_convert_command', 'doctrine:schema:create' => 'doctrine.schema_create_command', 'doctrine:schema:drop' => 'doctrine.schema_drop_command', 'doctrine:ensure-production-settings' => 'doctrine.ensure_production_settings_command', 'doctrine:cache:clear-entity-region' => 'doctrine.clear_entity_region_command', 'doctrine:mapping:info' => 'doctrine.mapping_info_command', 'doctrine:cache:clear-query-region' => 'doctrine.clear_query_region_command', 'doctrine:query:dql' => 'doctrine.query_dql_command', 'doctrine:schema:update' => 'doctrine.schema_update_command', 'doctrine:schema:validate' => 'doctrine.schema_validate_command', 'doctrine:mapping:import' => 'doctrine.mapping_import_command', 'doctrine:migrations:diff' => 'doctrine_migrations.diff_command', 'doctrine:migrations:sync-metadata-storage' => 'doctrine_migrations.sync_metadata_command', 'doctrine:migrations:list' => 'doctrine_migrations.versions_command', 'doctrine:migrations:current' => 'doctrine_migrations.current_command', 'doctrine:migrations:dump-schema' => 'doctrine_migrations.dump_schema_command', 'doctrine:migrations:execute' => 'doctrine_migrations.execute_command', 'doctrine:migrations:generate' => 'doctrine_migrations.generate_command', 'doctrine:migrations:latest' => 'doctrine_migrations.latest_command', 'doctrine:migrations:migrate' => 'doctrine_migrations.migrate_command', 'doctrine:migrations:rollup' => 'doctrine_migrations.rollup_command', 'doctrine:migrations:status' => 'doctrine_migrations.status_command', 'doctrine:migrations:up-to-date' => 'doctrine_migrations.up_to_date_command', 'doctrine:migrations:version' => 'doctrine_migrations.version_command', 'swoole:server:status' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStatusCommand', 'swoole:server:stop' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStopCommand', 'swoole:server:reload' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerReloadCommand', 'swoole:server:start' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerStartCommand', 'swoole:server:run' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerRunCommand', 'swoole:server:profile' => 'K911\\Swoole\\Bridge\\Symfony\\Bundle\\Command\\ServerProfileCommand', 'make:auth' => 'maker.auto_command.make_auth', 'make:command' => 'maker.auto_command.make_command', 'make:controller' => 'maker.auto_command.make_controller', 'make:crud' => 'maker.auto_command.make_crud', 'make:docker:database' => 'maker.auto_command.make_docker_database', 'make:entity' => 'maker.auto_command.make_entity', 'make:fixtures' => 'maker.auto_command.make_fixtures', 'make:form' => 'maker.auto_command.make_form', 'make:message' => 'maker.auto_command.make_message', 'make:messenger-middleware' => 'maker.auto_command.make_messenger_middleware', 'make:registration-form' => 'maker.auto_command.make_registration_form', 'make:reset-password' => 'maker.auto_command.make_reset_password', 'make:serializer:encoder' => 'maker.auto_command.make_serializer_encoder', 'make:serializer:normalizer' => 'maker.auto_command.make_serializer_normalizer', 'make:subscriber' => 'maker.auto_command.make_subscriber', 'make:twig-extension' => 'maker.auto_command.make_twig_extension', 'make:test' => 'maker.auto_command.make_test', 'make:unit-test' => 'maker.auto_command.make_test', 'make:functional-test' => 'maker.auto_command.make_test', 'make:validator' => 'maker.auto_command.make_validator', 'make:voter' => 'maker.auto_command.make_voter', 'make:user' => 'maker.auto_command.make_user', 'make:migration' => 'maker.auto_command.make_migration']);
    }
}
